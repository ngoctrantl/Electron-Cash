"""
A basic server implementation for testing. Does not include DoS preventions nor SSL support.
"""
...
class FusionServer(GenericServer):
    ...
    def start_fuse(self, tier):
        ...
        with self.lock:
            ...
            fusion = FusionController(self. network, tier, chosen_clients, self.bindhost, upnp = self.upnp)
            fusion.start()
